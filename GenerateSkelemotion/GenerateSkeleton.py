...
def main(path_to_folder, is_folder=True):
    print(is_folder)
    ...
    if is_folder:
        ...
        path_to_folder = os.path.split(path_to_folder)[0]
    ...
    for file in files:
        if file.endswith('.mp4'):
            ...
            if is_folder:
                os.system(f'python skeleton_images/GenerateSkeletonImages.py --data_path "{save_path}" --img_type 2 --temp_dist 10 --path_to_save "{save_path}"')
                image_path = os.path.join(path_to_folder, 'images')
            else:
                os.system(f'python ../GenerateSkelemotion/skeleton_images/GenerateSkeletonImages.py --data_path "{save_path}" --img_type 2 --temp_dist 10 --path_to_save "{save_path}"')
